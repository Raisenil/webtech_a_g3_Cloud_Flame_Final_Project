...
<body>
	...
	<section class="navbar">
		<div class="container">
			...
			<div class="logo">
				...
				<img src="admin/view/images/logo.jpg" alt="Restaurant Logo" class="img-responsive">
				</a>
			</div>
			...
			<div class="menu text-right">
				<ul>
					...
					<li>
						<a href="admin/view/catagories.php">Catagories</a>
					</li>
					<li>
						<a href="admin/view/foods.php">Foods</a>
					</li>
					<li>
						<a href="admin/view/book-a-table.php">Book a Table</a>
					</li>
					<li>
						<a href="admin/view/login.php">Account</a>
					</li>
					<li>
						<a href="admin/view/contacts.php">Contacts</a>
					</li>
					<li>
						<a href="admin/view/about.php">About</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<section class="food-search text-center">
		<div class="container">
			...
			<form action="view/foodsearch.php" method="POST">
			...
			<?php
				...
				if($count>0){
					while($row=mysqli_fetch_assoc($res)){
						...
						?>
						<a href="admin/view/categoryfoods.php?category_id=<?php echo $id; ?>">
							<div class="box-3 float-container">
								<?php
									if($image_name==""){
										echo "image not Available";
									}else{?>
										<img src="admin/view/images/catagory/<?php echo $image_name;?>" alt="Pizza" class="img-responsive img-curve">
										<?php
									}
								?>
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					<div class="food-menu-box">
						<div class="food-menu-img">
							<?php
								if($image_name=="")
								{
									...
									?>
										<img src="admin/view/images/food/<?php echo $image_name;?>"  class="img-responsive img-curve">
									<?php
								}
							?>
						...
						<div class="food-menu-desc">
							...
							<a href="admin/view/order.php?food_id=<?php echo $id;?>" class="btn-small btn-small-primary">Order now</a>
						</div>
					</div>
					<?php
				}
