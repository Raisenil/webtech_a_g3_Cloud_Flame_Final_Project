...
?>
    ...
    <ul>
		<li>
			<a class="btn btn-small btn-small-primary" href="employee-registration.php">Add User</a>
		</li>
    </ul>
        <table border="1">
    <tr>
            ...
            <?php  for($i=0; $i<count($users); $i++){ ?>
						<tr>
							...
							<td>
                            <a class='btn btn-small btn-small-primary' href='../view/eedit-user.php?
                                id=<?=$users[$i]['id']?>
                            ...
                            <td align='center'>
                                <a class='btn btn-red btn-red-primary' href='../view/edelete-user.php?
                                id=<?=$users[$i]['id']?>
                                &username=<?=$users[$i]['username']?>
                                &password=<?=$users[$i]['password']?>
                                &email=<?=$users[$i]['email']?>
