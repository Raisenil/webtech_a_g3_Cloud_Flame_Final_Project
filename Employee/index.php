...
<body>
	...
	<section class="navbar">
		<div class="container">
			...
			<div class="logo">
				...
				<img src="view/images/logo.jpg" alt="Restaurant Logo" class="img-responsive">
				</a>
			</div>
			...
			<div class="menu text-right">
				<ul>
					<li>
						<a href="eindex.php">Home</a>
					</li>
					<li>
						<a href="view/ecatagories.php">Catagories</a>
					</li>
					<li>
						<a href="view/efoods.php">Foods</a>
					</li>
					<li>
						<a href="view/ebook-a-table.php">Book a Table</a>
					</li>
					<li>
						<a href="view/elogin.php">Account</a>
					</li>
					<li>
						<a href="view/econtacts.php">Contacts</a>
					</li>
					<li>
						<a href="view/eabout.php">About</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<section class="food-search text-center">
		<div class="container">
			...
			<form action="view/efoodsearch.php" method="POST">
			...
			<?php
				...
				if($count>0){
					while($row=mysqli_fetch_assoc($res)){
						...
						?>
						<a href="view/ecategoryfoods.php?category_id=<?php echo $id; ?>">
							<div class="box-3 float-container">
								<?php
									if($image_name==""){
										echo "image not Available";
									}else{?>
										<img src="view/images/catagory/<?php echo $image_name;?>" alt="Pizza" class="img-responsive img-curve">
										<?php
									}
								?>
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					<div class="food-menu-box">
						<div class="food-menu-img">
							<?php
								if($image_name=="")
								{
									...
									?>
										<img src="view/images/food/<?php echo $image_name;?>"  class="img-responsive img-curve">
									<?php
								}
							?>
						...
						<div class="food-menu-desc">
							...
							<a href="view/eorder.php?food_id=<?php echo $id;?>" class="btn-small btn-small-primary">Order now</a>
						</div>
					</div>
					<?php
				}
