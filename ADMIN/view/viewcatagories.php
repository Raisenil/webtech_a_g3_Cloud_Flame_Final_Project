...
<div class="menu container">
            ...
            <ul>
					<li>
						<a class="btn btn-small btn-small-primary" href="addCatagories.php">Add Catagory</a>
					</li>
					<li>
						<a class="btn btn-small btn-small-primary" href="maincatagories.php">Main Catagory</a>
					</li>
            </ul>
            </div>
		<div>
	...
	<br>
			<center>
				<fieldset><legend>All Categories</legend>
				<table border="1">
					<tr>
						<th width="90px">id</th>
					...
					<?php  for($i=0; $i<count($users); $i++){ ?>
						<tr>
							...
							<td>
								<a class="btn btn-small btn-small-primary" href="editcatagory.php?
								id=<?=$users[$i]['id']?>
								&title=<?=$users[$i]['title']?>
							...
							<td>
								<a class="btn btn-red btn-red-primary" href="../model/deletecatagory.php?id=<?=$users[$i]['id']?>&image_name=<?=$users[$i]['image_name']?>">Delete</a>
							</td>
						</tr>
					<?php } ?>
				</table></fieldset>
