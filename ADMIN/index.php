		...
		<div class="container">
			...
			<div class="menu text-right">
				<ul>
					...
					<li>
						<a href="view/catagories.php">Catagories</a>
					</li>
					<li>
						<a href="view/foods.php">Foods</a>
					</li>
					<li>
						<a href="view/book-a-table.php">Book a Table</a>
					</li>
					<li>
						<a href="view/login.php">Account</a>
					</li>
					<li>
						<a href="view/contacts.php">Contacts</a>
					</li>
					<li>
			...
			<?php
				...
				if($count>0){
					while($row=mysqli_fetch_assoc($res)){
						...
						?>
						<a href="view/categoryfoods.php?category_id=<?php echo $id; ?>">
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					<div class="food-menu-box">
						...
						<div class="food-menu-desc">
							...
							<a href="view/order.php?food_id=<?php echo $id;?>" class="btn-small btn-small-primary">Order now</a>
						</div>
					</div>
					<?php
				}
