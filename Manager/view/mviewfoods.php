...
<section class="catagories">
    <div class="container">
            ...
            <ul>
					<li>
						<a class="btn btn-small btn-small-primary" href="maddFoods.php">Add Food</a>
					</li>
					<li>
						<a class="btn btn-small btn-small-primary" href="mmainfoods.php">Main Food</a>
					</li>
            </ul>
            </div>
		<div>
				...
				<table border="1">
					...
					<?php  for($i=0; $i<count($users); $i++){ ?>
						<tr>
							...
							<td>
								<a class="btn btn-small btn-small-primary" href="meditfood.php?
								id=<?=$users[$i]['id']?>
								&title=<?=$users[$i]['title']?>
							...
							<td>
								<a class="btn btn-red btn-red-primary" href="../model/mdeletefood.php?id=<?=$users[$i]['id']?>&image_name=<?=$users[$i]['image_name']?>">Delete</a>
							</td>
						</tr>
					<?php } ?>
				</table></fieldset>
