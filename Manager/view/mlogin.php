...
<body style="background-color: #06ebe0">
    ...
    <section class="navbar">
        <div class="container">
            ...
            <ul>
					...
					<li>
						<a href="mcatagories.php">Catagories</a>
					</li>
					<li>
						<a href="mfoods.php">Foods</a>
					</li>
					<li>
						<a href="mbook-a-table.php">Book a Table</a>
					</li>
					<li>
						<a href="mlogin.php">Account</a>
					</li>
					<li>
						<a href="mcontacts.php">Contacts</a>
					</li>
					<li>
						<a href="mabout.php">About</a>
					</li>
				</ul>
            </div>
    ...
    <div class="container">
            ...
            <center>
            <form id="form" action="../controller/mloginCheck.php" method="post">
            <table>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <br>
                    <a class="btn btn-red btn-red-primary" href="mregistration.php">Register</a>
                </td>
            </tr>
        </table>
        </form>
