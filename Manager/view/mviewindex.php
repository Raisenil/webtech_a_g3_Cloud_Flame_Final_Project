...
?>
	...
	<section class="food-search text-center">
		<div class="container">
			...
			<form action="mmainfoodsearch.php" method="POST">
			...
			<?php
				...
				if($count>0){
					while($row=mysqli_fetch_assoc($res)){
						...
						?>
						<a href="mviewcategoryfoods.php?category_id=<?php echo $id; ?>">
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					<div class="food-menu-box">
						...
						<div class="food-menu-desc">
							...
							<a href="morder.php?food_id=<?php echo $id;?>" class="btn-small btn-small-primary">Order now</a>
						</div>
					</div>
					<?php
				}
