...
<body>
		...
		<div class="container">
			...
			<div class="menu text-right">
				<ul>
					...
					<li>
						<a href="view/mcatagories.php">Catagories</a>
					</li>
					<li>
						<a href="view/mfoods.php">Foods</a>
					</li>
					<li>
						<a href="view/mbook-a-table.php">Book a Table</a>
					</li>
					<li>
						<a href="view/mlogin.php">Account</a>
					</li>
					<li>
						<a href="view/mcontacts.php">Contacts</a>
					</li>
					<li>
						<a href="view/mabout.php">About</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<section class="food-search text-center">
		<div class="container">
			...
			<form action="view/mfoodsearch.php" method="POST">
			...
			<?php
				...
				if($count>0){
					while($row=mysqli_fetch_assoc($res)){
						...
						?>
						<a href="view/mcategoryfoods.php?category_id=<?php echo $id; ?>">
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					<div class="food-menu-box">
						...
						<div class="food-menu-desc">
							...
							<a href="view/morder.php?food_id=<?php echo $id;?>" class="btn-small btn-small-primary">Order now</a>
						</div>
					</div>
					<?php
				}
